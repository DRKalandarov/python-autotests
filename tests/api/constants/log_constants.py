...
POST_REQUEST_FAILED = "При выполнении запроса POST /%s возникла ошибка: exception=%s"
POST_REQUEST_INFO = "request_params: headers=%s, data=%s"

PUT_REQUEST_START = "Отправка запроса PUT /%s/%s"
PUT_REQUEST_END = "Запрос PUT /%s/%s завершен: http_code=%s"
PUT_REQUEST_FAILED = "При выполнении запроса PUT /%s/%s возникла ошибка: exception=%s"
PUT_REQUEST_INFO = "request_params: headers=%s, data=%s"

DELETE_REQUEST_START = "Отправка запроса DELETE /%s/%s"
DELETE_REQUEST_END = "Запрос DELETE /%s/%s завершен: http_code=%s"
