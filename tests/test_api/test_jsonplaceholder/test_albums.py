...
class TestAlbums:
    ...
    def test_get_albums_list(self, jsonplaceholder_client: JsonplaceholderClient) -> None:
        """
    ...
    def test_get_album_by_id(self, jsonplaceholder_client: JsonplaceholderClient, id: int) -> None:
        """
    ...
    def test_create_album(self, jsonplaceholder_client: JsonplaceholderClient, album: dict[str, Any]) -> None:
        """
        Создание альбома
        """
        response = jsonplaceholder_client.create_resource(path=self.base_path, data=album)
        response_data = response.json()
    ...
    def test_update_album_by_id(self, jsonplaceholder_client: JsonplaceholderClient, album: dict[str, Any]) -> None:
        """
        Обновление альбома по id
        """
        resource_id = 10

        response = jsonplaceholder_client.update_resource_by_id(path=self.base_path, id=resource_id, data=album)
        response_data = response.json()
    ...
    def test_delete_album_by_id(self, jsonplaceholder_client: JsonplaceholderClient) -> None:
        """
