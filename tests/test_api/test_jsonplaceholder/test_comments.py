...
class TestComments:
    ...
    def test_get_comments_list(self, jsonplaceholder_client: JsonplaceholderClient) -> None:
        """
    ...
    def test_get_comment_by_id(self, jsonplaceholder_client: JsonplaceholderClient, post_id: int) -> None:
        """
        Получение комментария по id
        """
        response = jsonplaceholder_client.get_resource_by_id(path=self.base_path, id=post_id)
        response_data = response.json()
    ...
    def test_create_comment(self, jsonplaceholder_client: JsonplaceholderClient, comment: dict[str, Any]) -> None:
        """
        Создание комментария
        """
        response = jsonplaceholder_client.create_resource(path=self.base_path, data=comment)
        response_data = response.json()
    ...
    def test_update_comment_by_id(
        self, jsonplaceholder_client: JsonplaceholderClient, comment: dict[str, Any]
    ) -> None:
        """
        ...
        response = jsonplaceholder_client.update_resource_by_id(path=self.base_path, id=resource_id, data=comment)
        response_data = response.json()
    ...
    def test_delete_comment_by_id(self, jsonplaceholder_client: JsonplaceholderClient) -> None:
        """
